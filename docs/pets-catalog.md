...
|---|---|---|---|---|
| `fox` / Fox | quadruped / `fox-quadruped` | `tail.png`, `rear-far.png`, `rear-near.png`, `body.png`, `front-far.png`, `front-near.png`, `head.png` | `shadow.png`, `effect-back.png`, `head-closed.png`, `effect-front.png`, `particles.png`; Level 3 tail variants | Element Tail Bolt: `attack-cast.png`, `projectile.png`, `impact.png` |
| `wolf` / Wolf | quadruped / `quadruped-base` | `tail.png`, `rear-far.png`, `front-far.png`, `body.png`, `rear-near.png`, `front-near.png`, `head.png` | `shadow.png`, `mane.png`, `head-closed.png`, `jaw.png` | Fang Rush: `attack-cast.png`, `attack-trail.png`, `impact.png`; no projectile by default |
| `bunny` / Bunny | hopper / `hopper-base` | `rear-ear.png`, `body.png`, `hind-leg.png`, `front-paw.png`, `head.png`, `front-ear.png`, `tail.png` | `shadow.png`, `head-closed.png` | Burst Ram: `attack-trail.png`, `impact.png` |
| `turtle` / Turtle | tank / `tank-base` | `rear-feet.png`, `body.png`, `shell.png`, `front-feet.png`, `head.png` | `shadow.png`, `head-closed.png`, `shell-runes.png` | Element Cage: `attack-cast.png`, `cage.png`, `impact.png` |
| `dragon` / Dragon | winged / `winged-base` | `back-wing.png`, `tail.png`, `body.png`, `legs.png`, `front-wing.png`, `head.png` | `shadow.png`, `head-closed.png`, `horns.png`, `element-aura.png` | Element Meteor: `attack-cast.png`, `meteor.png`, `impact.png` |
| `owl` / Owl | winged / `winged-base` | `back-wing.png`, `tail-feathers.png`, `body.png`, `talons.png`, `front-wing.png`, `head.png` | `shadow.png`, `head-closed.png`, `forehead-rune.png` | Element Orb: `attack-cast.png`, `projectile.png`, `impact.png` |
| `golem` / Golem | tank / `tank-base` | `rear-arm.png`, `rear-leg.png`, `torso.png`, `core.png`, `front-leg.png`, `front-arm.png`, `head.png` | `shadow.png`, `rock-fragments.png` | Core Quake: `attack-cast.png`, `ground-wave.png`, `impact.png` |
...
| `serpent` / Serpent | serpent / `serpent-base` | `tail.png`, `body-lower.png`, `body-upper.png`, `head.png` | `shadow.png`, `head-closed.png`, `jaw.png`, `crest.png` | Element Lance: `attack-cast.png`, `beam.png`, `impact.png` |
| `hawk` / Hawk | winged / `winged-base` | `rear-wing.png`, `tail-fan.png`, `body.png`, `talons.png`, `front-wing.png`, `head.png` | `shadow.png`, `head-closed.png`, `crest.png` | Cyclone Dive: `attack-trail.png`, `vortex.png`, `impact.png` |
