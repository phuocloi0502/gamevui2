...
1. Tạo `assets/pets/<id>/asset.json` từ Fire Fox, dùng id kebab-case và rig phù hợp.
2. Lưu master và layer tại `public/assets/pets/<id>/`; đường dẫn src bắt đầu `/assets/pets/<id>/`.
