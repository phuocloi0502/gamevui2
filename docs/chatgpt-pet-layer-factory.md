...
| Serpent | serpent / `serpent-base` | `tail`, `body-lower`, `body-upper`, `head`, `eyes-open`, `eyes-closed` | `shadow`, `jaw`, `crest` | Element Lance: `attack-cast`, `beam`, `impact`. Spec: `docs/pet-production/serpent-production-spec.md` |
